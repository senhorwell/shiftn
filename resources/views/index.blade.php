...
<body>
                    ...
                    <div class="menu_area">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="{{ url('/welcome') }}">Welcome</a></li>
    ...
    <section class="wellcome_area clearfix" id="home">
        ...
        <div class="welcome-thumb wow fadeInDown" data-wow-delay="0.5s">
            <img src="{{URL::to('/')}}/img/bg-img/welcome-img.png" alt="">
        </div>
    </section>
    <!-- ***** Wellcome Area End ***** -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="{{URL::to('/')}}/img/bg-img/special.png" alt="">
                        </div>
                    </div>
    ...
    <div class="video-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Video Area Start -->
                    <div class="video-area" style="background-image: url({{URL::to('/')}}/img/bg-img/video.jpg);">
                ...
                <div class="col-12">
                    ...
                    <div class="app_screenshots_slides owl-carousel">
                        <div class="single-shot">
                            <img src="{{URL::to('/')}}/img/scr-img/app-1.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{URL::to('/')}}/img/scr-img/app-2.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{URL::to('/')}}/img/scr-img/app-3.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{URL::to('/')}}/img/scr-img/app-4.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{URL::to('/')}}/img/scr-img/app-5.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{URL::to('/')}}/img/scr-img/app-3.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="slider slider-nav">
                        <div class="client-thumbnail">
                            <img src="{{URL::to('/')}}/img/bg-img/client-3.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="{{URL::to('/')}}/img/bg-img/client-2.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="{{URL::to('/')}}/img/bg-img/client-1.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="{{URL::to('/')}}/img/bg-img/client-2.jpg" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{URL::to('/')}}/img/team-img/team-1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{URL::to('/')}}/img/team-img/team-2.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{URL::to('/')}}/img/team-img/team-3.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{URL::to('/')}}/img/team-img/team-4.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
    ...
    <!-- Footer Reveal JS -->
    <script src="{{URL::to('/')}}/js/footer-reveal.min.js"></script>
    <!-- Active JS -->
