...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(URL::to('/')); ?>/img/core-img/favicon.ico">

    <!-- Core Stylesheet -->
    <link href="<?php echo e(URL::to('/')); ?>/style.css" rel="stylesheet">
...
<body>
                ...
                <div class="col-12 col-lg-10">
                    <div class="menu_area">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <!-- Logo -->
                            <a class="navbar-brand" href="#">Shift N</a>
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ca-navbar" aria-controls="ca-navbar" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                            <!-- Menu Area -->
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                <li class="nav-item active"><a class="nav-link" href="#home">Home</a></li>
                                <li class="nav-item active"><a class="nav-link" href="<?php echo e(url('/welcome')); ?>">Welcome</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#about">Sobre</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#features">Caracteristicas</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#screenshot">Prints</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#pricing">Preços</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#testimonials">Testemunhas</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#team">Tema</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#contact">Contato</a></li>
                                </ul>
                                <div class="sing-up-button d-lg-none">
                                    <a href="#">Cadastre grátis</a>
                                </div>
                            </div>
                        </nav>
                    </div>
    ...
    <section class="wellcome_area clearfix" id="home">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    <div class="wellcome-heading">
                        <h2>Shift N</h2>
                        <h3>N</h3>
                        <p>Tudo que você precisa. Para começar fazer o que você quer.</p>
                    </div>
                    <div class="get-start-area">
                        <!-- Form Start -->
                        <form action="#" method="post" class="form-inline">
                            <input type="email" class="form-control email" placeholder="Email">
                            <input type="submit" class="submit" value="Começar">
                        </form>
                        <!-- Form End -->
                    </div>
                </div>
        ...
        <div class="welcome-thumb wow fadeInDown" data-wow-delay="0.5s">
            <img src="<?php echo e(URL::to('/')); ?>/img/bg-img/welcome-img.png" alt="">
        </div>
    </section>
    <!-- ***** Wellcome Area End ***** -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="<?php echo e(URL::to('/')); ?>/img/bg-img/special.png" alt="">
                        </div>
                    </div>
    ...
    <div class="video-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Video Area Start -->
                    <div class="video-area" style="background-image: url(<?php echo e(URL::to('/')); ?>/img/bg-img/video.jpg);">
                ...
                <div class="col-12">
                    ...
                    <div class="app_screenshots_slides owl-carousel">
                        <div class="single-shot">
                            <img src="<?php echo e(URL::to('/')); ?>/img/scr-img/app-1.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo e(URL::to('/')); ?>/img/scr-img/app-2.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo e(URL::to('/')); ?>/img/scr-img/app-3.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo e(URL::to('/')); ?>/img/scr-img/app-4.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo e(URL::to('/')); ?>/img/scr-img/app-5.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="<?php echo e(URL::to('/')); ?>/img/scr-img/app-3.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="slider slider-nav">
                        <div class="client-thumbnail">
                            <img src="<?php echo e(URL::to('/')); ?>/img/bg-img/client-3.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="<?php echo e(URL::to('/')); ?>/img/bg-img/client-2.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="<?php echo e(URL::to('/')); ?>/img/bg-img/client-1.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="<?php echo e(URL::to('/')); ?>/img/bg-img/client-2.jpg" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo e(URL::to('/')); ?>/img/team-img/team-1.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="https://www.instagram.com/wellwlds"> <i class="fa fa-instagram" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo e(URL::to('/')); ?>/img/team-img/team-2.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo e(URL::to('/')); ?>/img/team-img/team-3.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="<?php echo e(URL::to('/')); ?>/img/team-img/team-4.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                <a href="https://www.facebook.com/wellwlds"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://www.twitter.com/wellwlds"><i class="fa fa-twitter" aria-hidden="true"></i></a>
    ...
    <!-- Jquery-2.2.4 JS -->
    <script src="<?php echo e(URL::to('/')); ?>/js/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="<?php echo e(URL::to('/')); ?>/js/popper.min.js"></script>
    <!-- Bootstrap-4 Beta JS -->
    ...
    <!-- Footer Reveal JS -->
    <script src="<?php echo e(URL::to('/')); ?>/js/footer-reveal.min.js"></script>
    <!-- Active JS -->
    <script src="<?php echo e(URL::to('/')); ?>/js/active.js"></script>
</body>

</html>
<?php /**PATH /home/wellwlds/Downloads/shiftn/resources/views/index.blade.php ENDPATH**/ ?>